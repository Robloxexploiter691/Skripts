...
Teleports.Position = UDim2.new(0, 0, 0.18003425, 0)
...
local function VKZCT_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(VKZCT_fake_script)()
local function ICXCRL_fake_script() -- Minimize.LocalScript 
...
coroutine.wrap(ICXCRL_fake_script)()
local function ILGY_fake_script() -- Close.LocalScript 
...
coroutine.wrap(ILGY_fake_script)()
local function BAXJJ_fake_script() -- Home.LocalScript 
...
coroutine.wrap(BAXJJ_fake_script)()
local function DLBUOQ_fake_script() -- Scripts.LocalScript 
...
coroutine.wrap(DLBUOQ_fake_script)()
local function GKHG_fake_script() -- Teleports.LocalScript 
...
coroutine.wrap(GKHG_fake_script)()
local function WHWWWL_fake_script() -- IY.LocalScript 
...
coroutine.wrap(WHWWWL_fake_script)()
local function HVAPS_fake_script() -- Harkedv2.LocalScript 
...
coroutine.wrap(HVAPS_fake_script)()
local function KJUWBV_fake_script() -- Cartrideintordite.LocalScript 
...
coroutine.wrap(KJUWBV_fake_script)()
local function LKCKT_fake_script() -- Sylahub.LocalScript 
...
coroutine.wrap(LKCKT_fake_script)()
local function HOMQY_fake_script() -- Prizzlife.LocalScript 
...
coroutine.wrap(HOMQY_fake_script)()
local function JFMVQ_fake_script() -- Downhillmadness.LocalScript 
...
coroutine.wrap(JFMVQ_fake_script)()
local function RMOJ_fake_script() -- Rampjumpingonsportscar.LocalScript 
...
coroutine.wrap(RMOJ_fake_script)()
local function RBASL_fake_script() -- TRD.LocalScript 
...
coroutine.wrap(RBASL_fake_script)()
local function NISPMP_fake_script() -- Open.LocalScript 
...
coroutine.wrap(NISPMP_fake_script)()
local function UYUXPIH_fake_script() -- Open.LocalScript 
	local script = Instance.new('LocalScript', Open)
...
coroutine.wrap(UYUXPIH_fake_script)()
