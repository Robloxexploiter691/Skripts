...
local function WARV_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(WARV_fake_script)()
local function BEOZZU_fake_script() -- Close.LocalScript 
...
coroutine.wrap(BEOZZU_fake_script)()
local function OXVLSNP_fake_script() -- IY.LocalScript 
...
coroutine.wrap(OXVLSNP_fake_script)()
local function AWWEEI_fake_script() -- Cartrideintordite.LocalScript 
...
coroutine.wrap(AWWEEI_fake_script)()
local function HDMH_fake_script() -- SylaHubTRD.LocalScript 
...
coroutine.wrap(HDMH_fake_script)()
local function KLBH_fake_script() -- PrizzAdmin.LocalScript 
...
coroutine.wrap(KLBH_fake_script)()
local function HUNBN_fake_script() -- Open.LocalScript 
...
coroutine.wrap(HUNBN_fake_script)()
